...
define( "RECIPIENT_NAME", "VLE" );
define( "RECIPIENT_EMAIL", "info@stci.com.pk" );
...
$services = isset( $_POST['organization'] ) ? preg_replace( "/[^\.\-\_\@a-zA-Z0-9]/", "", $_POST['organization'] ) : "";
$subject = isset( $_POST['subject'] ) ? preg_replace( "/[^\.\-\_\@a-zA-Z0-9]/", "", $_POST['subject'] ) : "";
$website = isset( $_POST['Country'] ) ? preg_replace( "/[^\.\-\_\@a-zA-Z0-9]/", "", $_POST['Country'] ) : "";
